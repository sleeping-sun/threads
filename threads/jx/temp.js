...
(function(){
    ...
    jxcore.LTimeout = 60000;
    jxcore.ReConnCounter = 0;
    jxcore.Chunked = (jxcore.ffVersion > 0) || (false && (jxcore.ieVersion==0 || jxcore.ieVersion>8) ); /* for FF chunked should be true */
...
})(window);jxcore.clid='437a19731axT0@111452';jxcore.ListenUrl='/helloworld/jx';jxcore.SocketURL = (document.location.protocol == 'https:') ? 'wss://127.0.0.1' : 'ws://127.0.0.1:8000';